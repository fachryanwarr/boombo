...
<div class="flex min-h-full flex-col justify-center px-6 py-3 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <h2 class="mt-3 text-center text-2xl font-bold leading-9 tracking-tight text-white">Sign Up</h2>
    </div>
    ...
    <div class="mt-3 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <p class="mt-5 text-center text-sm text-gray-300">
        ...
        <a href="/auth/sign-in" class="font-semibold leading-6 text-white hover:text-indigo-500">Sign In</a>
      </p>
    </div>
