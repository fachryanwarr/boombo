...
<div class="mt-20 mx-auto w-[70%] md:w-[50%] px-4 py-5 sm:px-6 lg:px-8 border bg-gradient-to-r from-purple-500 to-pink-500 shadow-md rounded-lg">
    <div class="mx-auto max-w-lg text-center">
      <h1 class="text-2xl font-bold sm:text-3xl text-white">Withdraw</h1>
  
      <p class="mt-2 text-white">
        Insert your withdrawal amount.
      </p>
    </div>
  
    <form action="/mybalance/withdraw/" method="POST" class="mx-auto mb-0 mt-8 max-w-md space-y-4">
      @csrf
      <div>
